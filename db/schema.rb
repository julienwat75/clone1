...
ActiveRecord::Schema.define(version: 20140516181548) do
  ...
  create_table "authors", force: true do |t|
    ...
    t.string   "ville"
    t.string   "token"
    t.boolean  "limite_payante"
    t.integer  "point_positif"
    t.integer  "point_negatif"
    t.boolean  "alerte"
  end
  ...
  create_table "pagesystemes", force: true do |t|
